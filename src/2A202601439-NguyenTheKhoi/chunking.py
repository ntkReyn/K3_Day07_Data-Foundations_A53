...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Keep terminal punctuation with the preceding sentence.  Whitespace is
        # deliberately the delimiter, so a final sentence without punctuation is
        # still retained as a chunk.
        sentences = [
            sentence.strip()
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # With no useful separator left, character slices are the safe fallback.
    ...
    def compare(self, text: str, chunk_size: int = 200) -> dict:
        ...
        strategies = {
            "fixed_size": FixedSizeChunker(
                ...
                overlap=min(chunk_size // 10, max(0, chunk_size - 1)),
            ),
