...
class EmbeddingStore:
    ...
    def _make_record(self, doc: Document) -> dict[str, Any]:
        ...
        # Documents added directly by callers may not include a doc_id.  Keeping
        # it on every record makes deletion and metadata filtering predictable.
    ...
    def _format_chroma_results(result: dict[str, Any]) -> list[dict[str, Any]]:
        """Convert Chroma's column-oriented query response to this store's API."""
        ...
        return [
            {
                ...
                # Chroma cosine distance is lower-is-better; expose a
                # higher-is-better score to match the in-memory backend.
